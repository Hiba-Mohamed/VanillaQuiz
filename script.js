const questions = [
  ...
  },
  {
    ...
    explanation: "تُفَخَّم الراء إذا كانت مضمومة أو مفتوحة حسب قواعد التجويد.",
  },
  {
  ...
  },
  {
    ...
    - غنة ناقصة: تكون في النون الساكنة عند التنوين بالضمة أو الفتحة. 
    - غنة كاملة: تكون في النون الساكنة عند التنوين بالكسر أو في حالة الإدغام.
    - غنة أكمل ما تكون: في النون والميم المشددتين.
    - غنة انقص ما تكون: في حالة السكون التام في النون والميم عند الوقف.`,
  },
  {
